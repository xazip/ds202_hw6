...
Plot6 <- Plot5 + geom_text(aes(label = DogBreed), size = 1.5, vjust = 1.4, na.rm = TRUE) # Labels for each point

Plot7 <- Plot6 + scale_color_manual(values = c("toy" = "#330000", "terrier" = "#A98B2D", "non-sporting" = "#6FA86C", "sporting" = "#B04946", "hound" = "#5E4D6C", "herding" = "#D59E7B", "working" = "#415C55"), breaks = c("toy", "terrier", "non-sporting", "sporting", "hound", "herding", "working")) #Assigned specific color to each Dog.
